...
public abstract class Item {
	...
	public Item(World world, String name, boolean takeable, String description) {
		this.world = world;
		itemName = name;
		isTakeable = takeable;
	...
	public Item(World world, String name, String description) {
		this(world, name, true, description);
	}
