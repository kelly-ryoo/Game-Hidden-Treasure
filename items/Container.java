...
public class Container extends Item {
	...
	public Container(World world, String name, boolean takeable, String description) {
		super(world, name, takeable, description);
		items = new HashMap<String, Item>();
	}

	/**
	 * Determines whether an item can be added to this Container. By default, any
	 * item can be added.
	 * 
	...
	/**
	 * Determines whether an item can be removed from this container. By default,
